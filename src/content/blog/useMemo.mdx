...
Teraz sprawdzamy, czy wprowadzona przez użytkownika wartość została już wcześniej obliczona i zapisana w memo, jeśli tak - podajemy tę wartość bez zbędnego obliczania. Zaoszczędzamy wtedy komputerowi zachodu.
...
Teraz wystarczy tylko wyświetlić kwadrat liczby dla danego number:
